...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Golden Hour Home Boarding | A home away from home for your dog",
    ...
    openGraph: {
      title: "Golden Hour Home Boarding",
      description: "A holiday for them. Peace of mind for you.",
      type: "website",
      images: [{ url: imageUrl, width: 1731, height: 909, alt: "Golden Hour Home Boarding with a Golden Retriever and Labrador" }],
    },
    twitter: {
